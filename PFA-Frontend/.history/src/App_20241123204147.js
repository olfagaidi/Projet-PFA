  ...
  function App() {
    ...
    return (
      <Router>
        {/* Navbar visible uniquement sur les pages principales (accueil, connexion, inscription) */}
        ...
        {/* Navbar secondaire (visible sur toutes les autres pages) */}
        <Navbar />

        {/* Routes après la connexion */}
