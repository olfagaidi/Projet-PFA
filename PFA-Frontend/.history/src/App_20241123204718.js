...
import Login from './components/Auth/Login'; // Import the LoginModal component
import './App.css';
...
function App() {
  ...
  return (
    <Router>
      <Navbar isLoggedIn={isLoggedIn} openLoginModal={openLogin} /> {/* Pass the openLoginModal function to Navbar */}
      ...
      {showLoginModal && (
        <LoginModal setIsLoggedIn={setIsLoggedIn} closeModal={closeLogin} />
      )}
