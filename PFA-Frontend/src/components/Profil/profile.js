            ...
            <MDBCard>
              <MDBCardBody className="text-center">
                <MDBCardImage
                  ...
                  fluid
                />
                <h5 className="mt-3">Olfa Gaidi</h5> 
                <p className="text-muted">Pharmacienne Biologiste</p>
                <p className="text-muted">Béja, Tunis</p>
                  ...
                  <MDBCardBody className="p-0">
                    <MDBListGroup flush>
                      ...
                      <MDBListGroupItem className="d-flex align-items-center">
                        ...
                        <span className="ms-3">olfagaidi</span>
                      </MDBListGroupItem>
                      <MDBListGroupItem className="d-flex align-items-center">
                        <MDBIcon fab icon="twitter" style={{ color: '#4ECDC4' }} />
                        <span className="ms-3">@Olfa</span>
                      </MDBListGroupItem>
                      <MDBListGroupItem className="d-flex align-items-center">
                        <MDBIcon fab icon="instagram" style={{ color: '#4ECDC4' }} />
                        <span className="ms-3">Gaidi Olfa</span>
                      </MDBListGroupItem>
                      <MDBListGroupItem className="d-flex align-items-center">
                        <MDBIcon fab icon="facebook" style={{ color: '#4ECDC4' }} />
                        <span className="ms-3">Olfa Gaidi</span>
                      </MDBListGroupItem>
                    </MDBListGroup>
                  </MDBCardBody>
                </MDBCard>
